...
export default function CheckoutPage() {
  ...
  const [form, setForm] = useState({ name: "", email: "", phone: "", address: "", city: "", state: "", pincode: "", payment: "razorpay" });
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-card border border-border rounded-xl p-5">
            ...
            <div className="space-y-2">
              <label className="flex items-center gap-3 p-3 border rounded-lg cursor-pointer transition-colors border-primary bg-primary/5">
                <input type="radio" name="payment" value="razorpay" checked readOnly className="accent-primary" />
                <span className="text-sm">Razorpay (Test Mode)</span>
              </label>
            </div>
          </div>
        </div>
