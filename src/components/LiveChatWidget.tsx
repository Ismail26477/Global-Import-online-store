...
const botReplies = [
  ...
  "You can also email us at support@arcomputer.com for detailed assistance.",
...
export default function LiveChatWidget() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { id: "1", text: "Hi! 👋 Welcome to AR Computer. How can I help you today?", sender: "bot", time: new Date().toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" }) },
  ]);
          ...
          >
            ...
            <div className="bg-primary text-primary-foreground px-4 py-3 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-sm font-bold">AR Computer Support</p>
